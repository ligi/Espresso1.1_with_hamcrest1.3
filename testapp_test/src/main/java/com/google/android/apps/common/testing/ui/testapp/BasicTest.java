...
public class BasicTest extends ActivityInstrumentationTestCase2<SimpleActivity> {
    ...
    public void testTypingAndPressBack() {
        ...
        onView(withId(R.id.sendtext_simple)).perform(typeText("Have a cup of Espresso."), closeSoftKeyboard());

        onView(withId(R.id.send_simple)).perform(click());
        ...
        onView(withId(R.id.sendtext_simple)).check(matches(withText(containsString("Espresso"))));
    }
